document.addEventListener("DOMContentLoaded", function () {
  ...
  function calculateAndDisplayResults() {
    ...
    document.getElementById(
      "best-frame-size"
    ).textContent = `M${closestMatch.frameSize}`;
    document.getElementById(
      "best-stem-angle"
    ).textContent = `${closestMatch.stemAngle}°`;
    document.getElementById(
      "best-stem-length"
    ).textContent = `${closestMatch.stemLength}mm`;
    document.getElementById(
      "best-spacer-stack"
    ).textContent = `${closestMatch.spacerStack}mm`;

    if (closestNegStemMatch) {
      document.getElementById(
        "neg-stem-frame-size"
      ).textContent = `M${closestNegStemMatch.frameSize}`;
      document.getElementById(
        "neg-stem-angle"
      ).textContent = `${closestNegStemMatch.stemAngle}°`;
      document.getElementById(
        "neg-stem-length"
      ).textContent = `${closestNegStemMatch.stemLength}mm`;
      document.getElementById(
        "neg-stem-spacer-stack"
      ).textContent = `${closestNegStemMatch.spacerStack}mm`;
    } else {
      [
        "neg-stem-frame-size",
        "neg-stem-angle",
  ...
  function calculateHandlebarGeometry(
    frameData,
    stemAngle,
    stemLength,
    spacerStack
